...
--
-- Хост: localhost
-- Время создания: Апр 18 2023 г., 06:44
...
INSERT INTO `users` (`id`, `email`, `name`, `age`, `login`, `password`) VALUES
(4, 'sdafsarfbzrg@sfvsdfv.ru', 'ilya', 35, 'user', '1234'),
(5, 'sdafsarfbzrg@sfvsdfv.ru', 'ilya', 35, 'user', '1234');
